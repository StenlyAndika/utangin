...
class EvaluasiCicilan extends StatefulWidget {
  EvaluasiCicilan({Key? key}) : super(key: key);

  static const nameRoute = '/pageEvaluasiCicilan';

  @override
  State<EvaluasiCicilan> createState() => _EvaluasiCicilanState();
}

class _EvaluasiCicilanState extends State<EvaluasiCicilan> {
  String? menu;
  int selected = 1;
